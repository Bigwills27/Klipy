...
class KlipyDatabase {
  ...
  async authenticateUser(email, password) {
    try {
      console.log('Attempting authentication for:', email, 'using API:', `${this.baseUrl}/api/users`);
      ...
      if (error.name === 'TypeError' && error.message.includes('fetch')) {
        throw new Error('Network error: Cannot connect to server. Check your connection and try again.');
      }
      throw error;
    }
  }
