...
// MongoDB connection
const MONGODB_URI = process.env.MONGODB_URI || "mongodb+srv://yudtkme:yudtkme20@tabmc.zhquyvw.mongodb.net/klipy";
const JWT_SECRET = process.env.JWT_SECRET || 'klipy-secret-key-change-in-production';
...
app.listen(PORT, () => {
  ...
  console.log(`CORS enabled for: ${NODE_ENV === 'development' ? 'all origins' : 'production origins'}`);
});
